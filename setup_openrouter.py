...
def setup_openrouter():
    ...
    try:
        ...
        if success:
            ...
            print(
                "❌ OpenRouter connection failed. Check your API key and internet connection."
            )
            return False
...
def verify_integration():
    ...
    try:
        ...
        test_result = scorer.process_task(
            {"test": "integration_check"}, generation=0, current_fitness=0.5
        )
        ...
        if test_result.success:
            ...
            print(
                "⚠️ Fitness evaluation test had issues (may be normal without API key)"
            )

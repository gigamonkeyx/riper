...
class TestGPUPerformance:
    ...
    def test_gpu_benchmark(self):
        ...
        if tok_sec > 0:
            assert tok_sec >= GPU_PERFORMANCE_MIN, f"GPU performance too low: {tok_sec:.2f} tok/sec"
    
    @pytest.mark.skipif(not hasattr(pytest, "gpu_available"), reason="GPU not available")
    def test_gpu_memory_usage(self):
        ...
        try:
            ...
            assert memory_allocated < 10.0, f"Memory usage too high: {memory_allocated:.2f}GB"
